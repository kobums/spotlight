...
final class WebSearchProvider {
    ...
    func fallbackResult(for query: String) -> SearchResult? {
        ...
        return makeResult(engine: engines[0], term: trimmed, score: -1000)
    }
